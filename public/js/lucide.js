...
(function (a, n) {
	...
	const n = {
		...
		NC = (t) => Array.from(t.attributes).reduce((h, d) => ((h[d.name] = d.value), h), {}),
		KC = (t) =>
			typeof t == "string"
				? t
				: !t || !t.class
		...
		QC = (t) =>
			t
				...
				.join(" "),
		JC = (t) => t.replace(/(\w)(\w*)(_|-|\s*)/g, (h, d, c) => d.toUpperCase() + c.toLowerCase()),
		fa = (t, { nameAttr: h, icons: d, attrs: c }) => {
			const M = t.getAttribute(h);
			if (M == null) return;
			const p = JC(M),
				Va = d[p];
			if (!Va) return console.warn(`${t.outerHTML} icon name was not found in the provided icons object.`);
			const EC = NC(t),
		...
		B4 = [["path", { d: "M6 12h9a4 4 0 0 1 0 8H7a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h7a4 4 0 0 1 0 8" }]],
		F4 = [
			[
				"path",
				{
		...
		n5 = [["path", { d: "m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z" }]],
		l5 = [
		...
		L8 = [["path", { d: "M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z" }]],
		f8 = [
		...
		U8 = [["path", { d: "M15 6v12a3 3 0 1 0 3-3H6a3 3 0 1 0 3 3V6a3 3 0 1 0-3 3h12a3 3 0 1 0-3-3" }]],
		O8 = [
			[
				"path",
		...
		Tc = [["path", { d: "M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" }]],
		qc = [
			["path", { d: "M12 16h.01" }],
			["path", { d: "M16 16h.01" }],
			[
		...
		L7 = [["path", { d: "M18 22V2.8a.8.8 0 0 0-1.17-.71L5.45 7.78a.8.8 0 0 0 0 1.44L18 15.5" }]],
		f7 = [["path", { d: "M6 22V2.8a.8.8 0 0 1 1.17-.71l11.38 5.69a.8.8 0 0 1 0 1.44L6 15.5" }]],
		k7 = [
			[
				"path",
				{
		...
		Bp = [["path", { d: "M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8" }]],
		Fp = [
			["circle", { cx: "12", cy: "12", r: "10" }],
			["path", { d: "M12 16v-4" }],
			["path", { d: "M12 8h.01" }]
		...
		wi = [["path", { d: "M7 3.5c5-2 7 2.5 3 4C1.5 10 2 15 5 16c5 2 9-10 14-7s.5 13.5-4 12c-5-2.5.5-11 6-2" }]],
		Vi = [
		...
		xr = [["path", { d: "M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z" }]],
		ao = [
			["path", { d: "M9 2v6" }],
			["path", { d: "M15 2v6" }],
			["path", { d: "M12 17v5" }],
		...
		x$ = [["path", { d: "M12 3c7.2 0 9 1.8 9 9s-1.8 9-9 9-9-1.8-9-9 1.8-9 9-9" }]],
		ay = [
		...
		Js = [["path", { d: "M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" }]],
		Ys = [
...
lucide.createIcons({icons});\``);
		...
		if (
			(Array.from(c.querySelectorAll(`[${h}]`)).forEach((p) => fa(p, { nameAttr: h, icons: t, attrs: d })),
			M &&
				Array.from(c.querySelectorAll("template")).forEach((p) =>
					WC({ icons: t, nameAttr: h, attrs: d, root: p.content, inTemplates: M })
				),
			h === "data-lucide")
		) {
			...
			p.length > 0 &&
				...
				Array.from(p).forEach((Va) => fa(Va, { nameAttr: "icon-name", icons: t, attrs: d })));
		}
	};
	((a.AArrowDown = ka),
		(a.AArrowUp = Pa),
